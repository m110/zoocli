...
class CommandsTest(unittest.TestCase):
    ...
    def test_create(self):
        ...
        tests = [
            {'in': [],
             'expect': dict(value=None, ephemeral=False, sequence=False, makepath=False),
             },
            {'in': ['any_data'],
             'expect': dict(value=b'any_data', ephemeral=False, sequence=False, makepath=False),
             },
            {'in': ['-e'],
             'expect': dict(value=None, ephemeral=True, sequence=False, makepath=False),
             },
            {'in': ['-s'],
             'expect': dict(value=None, ephemeral=False, sequence=True, makepath=False),
             },
            {'in': ['-p'],
             'expect': dict(value=None, ephemeral=False, sequence=False, makepath=True),
             },
            {'in': ['any_data', '-ep'],
